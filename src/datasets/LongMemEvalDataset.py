...
class LongMemEvalInstance:
    def __init__(self, question_id, question, sessions, t_question, answer, question_type=None):
    ...
    def __repr__(self):
        return f"LongMemEvalInstance(question={self.question}, type={self.question_type}, sessions={self.sessions}, t_question={self.t_question}, answer={self.answer})"
